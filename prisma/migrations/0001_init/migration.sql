...
CREATE TABLE "Plan" (
    ...
    "pricePerCamera" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "AgentCamera" (
    ...
    CONSTRAINT "AgentCamera_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AgentToken_agentId_key" ON "AgentToken"("agentId");

-- CreateIndex
CREATE UNIQUE INDEX "AgentCamera_agentId_originalId_key" ON "AgentCamera"("agentId", "originalId");

-- CreateIndex
CREATE UNIQUE INDEX "AgentEvent_agentId_originalId_key" ON "AgentEvent"("agentId", "originalId");
...
-- AddForeignKey
ALTER TABLE "AgentToken" ADD CONSTRAINT "AgentToken_agentId_fkey" FOREIGN KEY ("agentId") REFERENCES "Agent"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "AgentCamera" ADD CONSTRAINT "AgentCamera_agentId_fkey" FOREIGN KEY ("agentId") REFERENCES "Agent"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "RemoteInstance" ADD CONSTRAINT "RemoteInstance_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "Organization"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
