...
const FEATURE_META = [
  ...
  },
  {
    ...
    description: 'Обнаружение предметов, оставленных без присмотра',
    icon: Package,
    defaultConfig: { thresholdSeconds: 120 },
  },
  {
    type: 'fall_detection',
    label: 'Обнаружение падений',
    description: 'Детекция падения человека по изменению позы',
    icon: PersonStanding,
    defaultConfig: {},
  },
  {
    type: 'tamper_detection',
    label: 'Детекция саботажа',
    description: 'Обнаружение закрытия, засвечивания или поворота камеры',
    icon: Eye,
    defaultConfig: {},
  },
  {
    type: 'fire_smoke_detection',
    label: 'Детекция огня/дыма',
    description: 'Обнаружение огня и дыма в кадре (требует Gemini AI)',
    icon: Flame,
    defaultConfig: {},
  },
  {
    type: 'ppe_detection',
    label: 'Контроль СИЗ',
    description: 'Проверка наличия спецодежды и средств защиты',
    icon: HardHat,
    defaultConfig: {},
  },
  {
    ...
    description: 'Автоматическое чтение автомобильных номеров',
    icon: Car,
    defaultConfig: {},
  },
  {
    ...
    description: 'Обнаружение пересечения виртуальных линий',
    icon: Axis3D,
    defaultConfig: {},
  },
];
